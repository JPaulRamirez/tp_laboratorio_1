...
/**
 * @brief Esta fución se ingresa los kilometros.
...
/**
 * @brief Esta función se ingresa los precios de Aerolineas ingresados.
 * @param precioAerolineas Recibe el float que corresponde los datos de Aerolineas ingresados.
...
/**
 * @brief Esta función se ingresa los precios de Latam ingresados.
 * @param precioLatam Recibe el float que corresponde los datos de Latam ingresados.
...
/**
 * @brief Esta función informa los resultados de Aerolineas y de Latam.
...
/**
 * @brief Esta función hace el descuento del precio ingresado.
...
/**
 * @brief Esta función hace un interes del precio ingresado.
 * @param precio Recibe el float que corresponde del precio ingresados.
...
/**
 * @brief Esta función calcula el precio unitario
 * @param precio Recibe el float que corresponde del precio ingresados.
 * @param kilometros Recibe el float que corresponde a los kilometros ingresados.
...
/**
 * @brief Esta función calcula la diferencia del precio Aerolineas con Latam.
...
/**
 * @brief Esta función se encarga de mostrar exactamente los resultado sin ingresar ninguna opción previamente.
 * @param km Recibe el float que corresponde a los kilometros ingresados.
